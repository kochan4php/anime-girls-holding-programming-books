...
export default async function Main({ title, children }: { children: React.ReactNode; title: string }) {
    ...
    return (
        <div className="relative min-h-screen md:flex md:justify-between w-[100%]">
            ...
            <main className="w-full absolute right-0 top-0 bottom-0 sm:w-[65%] md:w-[80%] py-8 px-4 md:p-6 mt-10 md:mt-0 overflow-y-auto">
                <h1 className="text-center mb-5 text-2xl md:text-3xl font-bold">{title}</h1>
